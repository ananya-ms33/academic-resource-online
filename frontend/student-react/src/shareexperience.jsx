            ...
            <div className="db">
                <div className="loginpg2">
                    ...
                    <div className="fcont">
                        ...
                        <div className="finp">
                            <textarea placeholder="Your Interview Experience..." rows="8" style={{ width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid #e2e8f0' }} onChange={(e) => setcontent(e.target.value)}></textarea>
                        </div>
